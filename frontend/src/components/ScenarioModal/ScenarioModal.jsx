// frontend/src/components/ScenarioModal/ScenarioModal.jsx
...
function ScenarioModal({ isOpen, onClose, onLoad, currentNodes, currentConnections }) {
  ...
  const handleLoad = async () => {
    ...
    try {
      const res = await axios.get(`${API_BASE}/api/scenarios/${selectedId}`);
